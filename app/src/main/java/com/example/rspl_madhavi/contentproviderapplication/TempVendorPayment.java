...
public class TempVendorPayment {
    public TempVendorPayment() {
    }


    private String TICKET_ID = "TICKET_ID";
    private String PAY_ID="PAY_ID";
    private String VEND_DSTR_NM= "VEND_DSTR_NM";
    private String AMOUNT= "AMOUNT";
    private String RECEIVED_AMOUNT=  "RECEIVED_AMOUNT";
    private String DUE_AMOUNT= "DUE_AMOUNT";
    private String REASON_OF_PAY = "REASON_OF_PAY";
    ...
    public String getVEND_DSTR_NM() {
        return VEND_DSTR_NM;
    }

    public void setVEND_DSTR_NM(String VEND_DSTR_NM) {
        this.VEND_DSTR_NM = VEND_DSTR_NM;
    }
    ...
    public String getREASON_OF_PAY() {
        return REASON_OF_PAY;
    }

    public void setREASON_OF_PAY(String REASON_OF_PAY) {
        this.REASON_OF_PAY = REASON_OF_PAY;
    }
