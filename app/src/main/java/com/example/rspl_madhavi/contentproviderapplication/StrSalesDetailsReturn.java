...
public class StrSalesDetailsReturn {
    public StrSalesDetailsReturn() {
    }
    ...
    private String BATCH_NO="BATCH_NO";
    ...
    private String DISC_PERC=  "DISC_PERC";
    private String DISC_VAL=  "DISC_VAL";
    private String TAX_PER =  "TAX_PER";
    private String TAX_VALUE =  "TAX_VALUE";
    private String TAX_PER1 =  "TAX_PER1";
    private String TAX_VALUE1= "TAX_VALUE1";
    private String TAX_PER2= "TAX_PER2";
    private String TAX_VALUE2="TAX_VALUE2";
    private String TAX_PER3="TAX_PER3";
