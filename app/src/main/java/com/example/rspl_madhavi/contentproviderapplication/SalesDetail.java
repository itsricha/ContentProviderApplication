...
public class SalesDetail {
    ...
    String DISC_PERC= "DISC_PERC";
    String DISC_VAL= "DISC_VAL";
    String TAX_PER= "TAX_PER";
    String TAX_VALUE= "TAX_VALUE";
    String TAX_PER1= "TAX_PER1";
    String TAX_VALUE1= "TAX_VALUE1";
    String PREFIX_ID= "PREFIX_ID";
    String TAX_PER2= "TAX_PER2";
    String TAX_VALUE2= "TAX_VALUE2";
    String TAX_PER3= "TAX_PER3";
    String TAX_VALUE3= "TAX_VALUE3";
    String LAST_MODIFIED= "LAST_MODIFIED";
    String FLAG= "FLAG";
    String S_FLAG= "S_FLAG";
    String CONV_FACT= "CONV_FACT";
    String SALE_DATE= "SALE_DATE";
    String POS_USER= "POS_USER";
    String M_FLAG= "M_FLAG";
    String EX_TRI_ID= "EX_TRI_ID";
    String ORDER_TYPE= "ORDER_TYPE";
    String PICK_UP_LOCATION= "PICK_UP_LOCATION";
    String DISCOUNT_PERCENT= "DISCOUNT_PERCENT";
    String LINE_ITEM_DISC = "LINE_ITEM_DISC";
    String LINE_DISC= "LINE_DISC";
    String PROD_ID= "PROD_ID";
    String BANK_NAME= "BANK_NAME";
    String CARD_TYPE= "CARD_TYPE";
    String SLAVE_FLAG= "SLAVE_FLAG";
    ...
    public String setTRI_ID(String TRI_ID) {
        this.TRI_ID = TRI_ID;
        return TRI_ID;
    }
    ...
    public String getTAX_VALUE3() {
        return TAX_VALUE3;
    }

    public void setTAX_VALUE3(String TAX_VALUE3) {
        this.TAX_VALUE3 = TAX_VALUE3;
    }
