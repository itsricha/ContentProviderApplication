...
public class RetailBillVisible {

    public RetailBillVisible() {
    }
    ...
    public String getNORMAL_SALES() {
        return NORMAL_SALES;
    }

    public void setNORMAL_SALES(String NORMAL_SALES) {
    ...
    String CITY="CITY";
    String STORE_COUNTRY="STORE_COUNTRY";
    String  ZIP= "ZIP";
    String TELE_1= "TELE_1";
    String TELE_2= "TELE_2";
    String MAIN_BODY= "MAIN_BODY";
    String MRP= "MRP";
    ...
    String CREDIT_CUSTOMER= "CREDIT_CUSTOMER";
