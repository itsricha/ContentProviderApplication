...
public class StrDistributor {
    public StrDistributor() {
    }

    private String STORE_ID="STORE_ID";
    private String DSTR_ID = "DSTR_ID";
    private String DSTR_NM="DSTR_NM";
    private String DSTR_CNTCT_NM= "DSTR_CNTCT_NM";
    private String ADD_1="ADD_1";
    private String CITY="CITY";
    private String CTR_NM="CTR_NM";
    private String ZIP="ZIP";
    private String TELE="TELE";
    private String MOBILE="MOBILE";
    private String DSTR_INV="DSTR_INV";
